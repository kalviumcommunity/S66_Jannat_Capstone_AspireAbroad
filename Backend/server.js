...
// 1. Setup CORS for all Express routes (REST API)
app.use(cors({
  origin: [
    "http://localhost:5173",
...
// 8. Fetch user documents endpoint
...
// 9. Setup HTTP server & Socket.IO with CORS config
...
// 11. Connect to MongoDB and start server
