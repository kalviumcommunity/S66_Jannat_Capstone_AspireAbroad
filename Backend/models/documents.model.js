...
const documentSchema = new mongoose.Schema({
  ...
  visaType: {
    type: String,
    enum: ["Tourist", "Work", "Study", "Permanent"],
    required: true,
  },
  ...
  documents: {
    ...
    FrequentTravelProof: {
      type: String,
      required: function () {
        return this.visaType === "Tourist";
      },
    },
    FinancialStabilityProof: {
      type: String,
      required: function () {
        return this.visaType === "Tourist";
      },
    },
    AccommodationTravelDetails: {
      type: String,
      required: function () {
        return this.visaType === "Tourist";
      },
    },
    PurposeOfVisitLetter: {
      type: String,
      required: function () {
        return this.visaType === "Tourist";
      },
    ...
    ProofOfFunds: {
      type: String,
      required: isRequiredForVisaTypes(["Work", "Permanent"]),
    },
    RelationProof: {
      type: String,
      required: function () {
    ...
    ResidencyProof: {
      type: String,
      required: function () {
        return this.visaType === "Permanent";
      },
    },
    BackgroundCheck: {
      type: String,
