...
const UKPR = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(
          `https://jannat-aspireabroad.onrender.com/UK/visa?visaType=Permanent`
        );
        if (!response.ok) {
  ...
  const calculatePoints = () => {
    ...
    if (form.experience === '5+') total += 20;
    if (form.experience === '3-4') total += 15;
    if (form.experience === '1-2') total += 10;
    
    
    if (form.english) total += 10;
    if(form.ukExperience) total+=10;
  ...
  const checkOccupationDemand = () => {
    ...
    setOccupationDemand(ukOccupations[selectedOccupation] || 'Low');
  };
    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <div className="p-6 max-w-7xl mx-auto">
          ...
          <p className="text-xl text-gray-700 mb-8">Your pathway to permanent residence in the UK</p>
                ...
                <div className="bg-gradient-to-br from-[#003366] to-[#0055a5] rounded-xl p-6 shadow-xl text-white">
                  <div className="flex flex-col md:flex-row gap-6">
                    <div className="md:w-2/3">
                      ...
                      <p className="mb-6">Find out if you qualify for UK Permanent Residence</p>
                      ...
                      <div className="mb-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                          ...
                          <label className="flex items-center space-x-2">
                            <input
                              type="checkbox"
                              checked={form.ukExperience}
                              onChange={() => setForm({...form, ukExperience: !form.ukExperience})}
                              className="h-5 w-5 rounded border-white border-opacity-50 bg-white bg-opacity-10"
                            />
                            <span>UK Experience</span>
                          </label>
                    ...
                    <div className="md:w-1/3 flex flex-col">
                      <div className="bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg p-4 backdrop-blur-sm flex-grow flex flex-col items-center justify-center">
                        <div className="text-center mb-4">
                          ...
                          <div className={`text-5xl font-bold my-2 ${points >= 70 ? 'text-green-600' : 'text-yellow-400'}`}>
                            {points}
                          </div>
                          <div className={`text-lg font-medium ${points >= 70 ? 'text-green-600' : 'text-yellow-400'}`}>
                          {points >= 70 ? 'Likely Eligible' : 'Needs Review'}
                          </div>
                        </div>
                        <div className="w-full bg-white bg-opacity-30 rounded-full h-2 mb-4">
                          <div 
                            className={`h-full rounded-full ${points >= 70 ? 'bg-green-600' : 'bg-yellow-400'}`}
                  ...
                  <div className="relative">
                    ...
                    <div className="space-y-8">
                      {[
                        ...
                        { step: "Secure Job Offer/Sponsorship", icon: "💼", color: "bg-purple-100 text-purple-800" },
                        { step: "Apply for Work Visa", icon: "✍️", color: "bg-green-100 text-green-800" },
                        { step: "Live & Work in UK (5 Years)", icon: "🏠", color: "bg-yellow-100 text-yellow-800" },
                        { step: "Pass Life in UK Test", icon: "📚", color: "bg-red-100 text-red-800" },
                        { step: "Apply for ILR", icon: "🛂", color: "bg-indigo-100 text-indigo-800" },
                        { step: "Biometrics & Decision", icon: "✅", color: "bg-teal-100 text-teal-800" }
                      ].map((item, index) => (
                ...
                <div className="border-2 border-[#003366] rounded-xl p-6 shadow-md bg-white">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-center space-x-3">
                      ...
                      <span className="font-semibold">No Criminal Records</span>
                    </li>
                  </ul>
                </div>
