...
import CountryNav from '../components/CountryNav'; // Correct path to the component
import { useParams, useNavigate } from 'react-router-dom';
import Canbac from "../assets/CanadaBackground.webp"; // Ensure image path is correct
      ...
      <div className="relative min-h-screen">
        ...
        <div className="my-8 px-6 text-center flex flex-col ">
          ...
          <p className="text-gray-600 text-lg">
            Explore top universities and colleges in Canada tailored to your academic goals.
          </p>
        </div>
