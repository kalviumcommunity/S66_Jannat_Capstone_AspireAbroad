    ...
    const fetchData = async () => {
      ...
      try {
        const response = await fetch(
          `https://jannat-aspireabroad.onrender.com/Australia/visa?visaType=${visaType}`
        );
        if (!response.ok) {
                ...
                {visaData.map((visa, index) => (
                  ...
                  >
                    ...
                    <div className="flex justify-end mt-4">
                      <button
                        className={`bg-[#B52721] text-white px-6 py-2 rounded-lg text-lg font-bold transition hover:bg-red-700 cursor-pointer ${
                ...
                <div className="border-2 border-[#003366] rounded-xl p-6 shadow-md bg-white">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      <li key={index} className="flex items-center space-x-3">
                        <div className="w-7 h-7 flex items-center justify-center bg-[#B52721] text-[#003366] rounded-full ">
...
export default TouristAustralia;
