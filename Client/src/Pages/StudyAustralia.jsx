      ...
      <div className="relative min-h-screen">
        ...
        <div className="my-8 px-6 text-center flex flex-col ">
            ...
            <p className="text-gray-600 text-lg">
              Explore top universities and colleges in Australia tailored to your academic goals.
            </p>
          </div>
          ...
          <div className="mt-12 text-center">
            <button
              ...
              className="px-6 py-4 bg-[#003366] text-white rounded-md hover:bg-[#B52721] transition-all cursor-pointer" onClick={()=>visaPage(country)}
            >
