...
import ukBackground from "../assets/UKBackground.webp";
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://jannat-aspireabroad.onrender.com/UK/visa?visaType=Tourist"
        );
        if (!response.ok) {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div
        ...
        style={{
          background: `linear-gradient(rgba(255, 255, 255, 0.4), rgba(255, 255, 255, 0.4)),url(${ukBackground})`,
              ...
              <div className="w-full md:w-1/3 space-y-6">
                ...
                <div className="border-2 border-[#003366] rounded-xl p-6 shadow-md bg-white">
                  ...
                  <ol className="space-y-4">
                    {["Check your eligibility", "Gather necessary documents", "Apply online through the official portal", "Pay the visa application fee", "Wait for processing and approval", "Receive your visa decision"].map((step, index) => (
                ...
                <div className="border-2 border-[#003366] rounded-xl p-6 shadow-md bg-white">
                  ...
                  <ul className="space-y-4">
                    {[
                      ...
                      "Proof of frequent travel (previous visas, travel history)",
                      "Evidence of financial stability (bank statements, payslips, etc.)",
                      "Accommodation details and travel itinerary",
                      "Employment or business ownership proof",
                      "Letter explaining purpose of frequent visits"
                    ].map((doc, index) => (
                      <li key={index} className="flex items-center space-x-3">
                        <div className="w-7 h-7 flex items-center justify-center bg-[#B52721] text-white rounded-full">
                          📄
