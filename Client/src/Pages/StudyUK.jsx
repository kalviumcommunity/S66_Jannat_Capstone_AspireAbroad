...
const StudyUK = () => {
  ...
  useEffect(() => {
    const fetchColleges = async () => {
      ...
      try {
        const response = await fetch('https://jannat-aspireabroad.onrender.com/college?country=UK');
      ...
      <div className="relative min-h-screen">
        ...
        <div className="my-8 px-6 text-center flex flex-col ">
          ...
          <p className="text-gray-600 text-lg">
            Explore top universities and colleges in United Kingdom tailored to your academic goals.
          </p>
        </div>
